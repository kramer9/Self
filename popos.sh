...
sudo apt install --reinstall ca-certificates ## fixing Unacceptable TLS certificate
...
flatpak install flathub com.calibre_ebook.calibre org.mozilla.firefox org.freefilesync.FreeFileSync fr.handbrake.ghb org.onlyoffice.desktopeditors com.github.micahflee.torbrowser-launcher com.transmissionbt.Transmission org.videolan.VLC com.yubico.yubioath com.visualstudio.code -y
